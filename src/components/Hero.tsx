        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-sm border border-white/30 rounded-full mb-md">
            ...
            <span className="text-white text-sm font-semibold">
              Trusted by 10,000+ Clients • 95% Success Rate • 2,847 Assessments Completed
            </span>
          </div>
          
          {/* Urgency Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-500/90 backdrop-blur-sm border border-red-400 rounded-full mb-md animate-pulse">
            <span className="text-white">⚡</span>
            <span className="text-white text-sm font-bold">
              LIMITED: Only 12 Assessment Spots Available This Week
            </span>
          </div>
          ...
          <p className="text-lg md:text-xl leading-relaxed mb-lg text-white/95 drop-shadow">
            Cape Town-based visa consultants serving South Africa nationwide (virtually via WhatsApp). Get a{' '}
            <a href="/services" className="text-white underline hover:no-underline font-semibold">
              Visa Assessment & Second Opinion
            </a>
            , plus support for UK, Schengen, Canada, USA, Australia, study and work visas. Trusted by 10,000+ clients, 24/7 support.
          </p>
